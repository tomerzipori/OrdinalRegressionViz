...
#' response criteria stricter. See `data-raw/sdt_ratings.R` in the source
#' repository for the exact generating code.
#'
#' @format A data frame with 4,000 rows and 5 variables:
#' \describe{
#'   \item{id}{Participant identifier (factor, 50 levels).}
#'   \item{condition}{Between-participant condition: `control` or
#'     `inoculation`.}
#'   \item{time}{Measurement occasion: `pre` or `post` intervention.}
#'   \item{target}{Type of headline: `fake` or `true`.}
#'   \item{value}{Perceived-truth rating on an ordered 1--6 scale
